...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0migrate.ps1" -Action %ACTION% -Migration %MIGRATION% -Environment Development -DatabaseConnection "%DB_CONNECTION%" -RedisConnection "%REDIS_CONNECTION%"
