...
powershell -NoProfile -ExecutionPolicy Bypass -File "%~dp0migrate.ps1" -Action %ACTION% -Migration %MIGRATION% -Environment Staging -DatabaseConnection "%DB_CONNECTION%" -RedisConnection "%REDIS_CONNECTION%"
